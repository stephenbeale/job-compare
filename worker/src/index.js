...

{
  ...
  "commuteMethod": "'car' if driving is mentioned, otherwise 'other'. Default 'other'.",
  "commuteDistanceMiles": "null (user should fill this in themselves)",
  "commuteVehicleMpg": "null (user should fill this in themselves)",
  ...
  "pensionEmployerMatchMax": "Maximum percentage the employer will match. null if not stated or no cap mentioned.",
  "pensionEmployeeMax": "Maximum allowable employee pension contribution as a percentage. null if not stated.",
  "pensionType": "'db' for defined benefit (final salary/career average), 'dc' for defined contribution (money purchase). Default 'dc' if not stated.",
